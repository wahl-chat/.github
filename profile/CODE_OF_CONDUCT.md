...
This organization and all projects within exist to promote reliable, democratic engagement. By participating here (as a user, contributor, maintainer, or deployment partner), you agree to follow this Code of Conduct.
...
## 1) Purpose & Scope
This Code applies to all project spaces of the wahl.chat organization (GitHub issues/PRs, discussions, docs, deployments, events) and to any use of the wahl.chat technology derived from this repo.
